...
public class TurnOffAds extends AppCompatActivity implements View.OnClickListener {
     ...
     */
    private TextView turnOffAds_backButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Assign TextViews
        turnOffAds_backButton = findViewById(R.id.turnOffAds_backButton);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.back:
                ...
                turnOffAds_backButton.setTextColor(Color.BLACK);
                break;
